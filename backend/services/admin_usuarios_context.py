"""Runtime context for Admin Usuarios service modules."""
...
def configure_admin_usuarios_context(runtime_module=None):
...
configure_admin_usuarios_context()

__all__ = ["configure_admin_usuarios_context", "get_tenant_id"]
