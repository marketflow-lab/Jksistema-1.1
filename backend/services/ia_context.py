"""Runtime context for IA service modules."""
...
def configure_ia_context(runtime_module=None):
...
configure_ia_context()

__all__ = ["configure_ia_context", "get_tenant_id", "get_tenant_path"]
