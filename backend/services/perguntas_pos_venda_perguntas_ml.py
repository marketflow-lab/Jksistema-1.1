...
def _perguntas_ia_gerar_resposta(
    ...
    if intencao_atendimento.get("fluxo") == "pos_venda":
        ...
        prompt = (
            ...
            "Se apenas a original estiver documentada, informe esse padrao como referencia, sem atribui-lo "
            "automaticamente a reposicao anunciada. Peca a informacao decisiva somente se a pesquisa nao resolver "
