...
def _notify_pending_approval(
    ...
    *,
    ...
    del renewed
    response = (
        "Este pedido exige aprovacao no aplicativo JK Sistema. No WhatsApp, somente a resposta "
        "de pergunta do Mercado Livre pode ser aprovada pelo botao tokenizado Aprovar e enviar."
    )
