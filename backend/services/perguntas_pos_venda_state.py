...
def _perguntas_ia_classification_prompt(
    ...
    *,
    ...
    return (
        ...
        "Distinga relato de compra existente de duvida hipotetica antes da compra: 'se nao servir posso devolver?' "
        "ou 'qual a politica de reembolso?' sem relato de compra existente continuam em perguntas_anuncio, "
        "duvida_produto e warranty_originality. Perguntas mistas preservam todas as subperguntas. "
        "Quando qualquer subpergunta exigir regra ou procedimento do Mercado Livre, incluindo cancelamento, "
        "reembolso, devolucao, mediacao ou funcionamento da plataforma, inclua politica_oficial_ml em "
        "required_evidence dessa subpergunta. Esse marcador solicita consulta oficial separada e nao muda "
        "o fluxo nem as flags de pesquisa tecnica. "
