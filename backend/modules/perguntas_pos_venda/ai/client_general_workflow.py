...
def initial_general_response(
    ...
    *,
    ...
    internal_prompt = prompt + (
        ...
        "dos fatos: exemplos ensinam estilo e abordagem, nunca fatos de produto. A API oficial comprova o estado "
        "do anuncio; atributos tecnicos do vendedor devem ser confrontados com referencias sustentadas do SKU, "
        "sem prioridade automatica do anuncio. Notas editoriais sem suporte nao comprovam fatos. "
        "Todos os produtos vendidos pela loja sao novos; se a pergunta for sobre produto usado ou condicao, responda que e novo "
        "e nao solicite confirmacao ao comprador. "
        "Em compatibilidade com familia, modelo, serie ou ano amplo, nao conclua cobertura total pela citacao de algumas "
        "versoes. Marque requires_human_review=true para o orquestrador pesquisar o universo de variantes e a cobertura "
        "da referencia exata do produto. "
