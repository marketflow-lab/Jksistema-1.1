    ...
    *,
    ...
    if sku_context:
        ...
        compact_prompt = (
            ...
            "Se a resolucao identificar a caracteristica da peca original equivalente, use-a para responder "
            "naturalmente sobre o produto; se confirmar apenas o padrao original, apresente-o como referencia "
            "sem afirmar que a unidade anunciada possui essa caracteristica. So peca um dado decisivo se "
    ...
    return (
        ...
        "identificado. Use-a como caracteristica do produto anunciado apenas com equivalencia de codigo, "
        "funcao e variacao; caso contrario, diga qual e o padrao original como referencia separada. "
