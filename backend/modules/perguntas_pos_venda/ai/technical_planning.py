...
def technical_evidence_graph_prompt(
    ...
    *,
    ...
    return (
        ...
        "textos devem sustentar separadamente a ligacao do SKU/variacao com a peca/referencia e a ligacao dessa "
        "referencia com o alvo. Registre componente, posicao, lado, cor e variacao dos codigos antes de tratar "
        "uma lista misturada como equivalencia. A API oficial atesta o conteudo do anuncio, nao a exatidao "
        "tecnica dos atributos do vendedor. Fotos ou respostas anteriores da loja, isoladamente, nao "
        "estabelecem esses vinculos. ResearchPassageV1 e demais "
