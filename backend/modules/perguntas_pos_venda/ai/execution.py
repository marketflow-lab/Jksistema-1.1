    ...
    *,
    ...
    if fluxo_pos_venda:
        ...
        partes.extend([
            ...
            "Nao mencione SKU, codigo interno, quantidade em estoque, status do anuncio, nome da loja fora da assinatura obrigatoria ou link do proprio anuncio. Quantidade comprovada do kit, como par ou duas unidades, nao e estoque e deve ser respondida quando perguntada.",
            ...
            "Se o alvo for familia, modelo, serie ou ano amplo, use a pesquisa do universo completo de versoes e da cobertura da referencia exata. Confirme sem condicao somente com 100% das versoes cobertas no mercado e periodo definidos; cobertura parcial exige resposta condicional.",
