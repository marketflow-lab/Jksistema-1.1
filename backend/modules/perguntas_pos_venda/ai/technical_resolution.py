...
def technical_resolution_prompt(
    ...
    *,
    ...
    return (
        ...
        "especificacao original da peca do veiculo. Uma caracteristica da original pode sustentar a resposta sobre "
        "a reposicao apenas com equivalencia de codigo, funcao e variacao; sem essa ligacao, registre o padrao "
        "original como referencia distinta da unidade anunciada. Resultado vazio ou falha de pesquisa nunca prova incompatibilidade. Nao "
