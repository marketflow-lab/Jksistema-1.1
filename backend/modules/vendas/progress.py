...
from .sync_persistence import _vendas_sync_load_state, _vendas_sync_update_job
...
def cancelar_sincronizacao_vendas(client_id: str):
...
def progresso_sincronizacao_vendas(client_id: str):
