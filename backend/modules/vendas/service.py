...
class VendasService:
    ...
    def relatorio_pareto(self, **kwargs): return self.repository.relatorio_pareto(**kwargs)
    def exportar_relatorio_pareto(self, **kwargs): return self.repository.exportar_relatorio_pareto(**kwargs)
    def relatorio_geral_skus(self, **kwargs): return self.repository.relatorio_geral_skus(**kwargs)
    def exportar_relatorio_geral_skus(self, **kwargs): return self.repository.exportar_relatorio_geral_skus(**kwargs)
