...
LEGACY_SHARED_SYNC_ROUTES: tuple[LegacyRouteSpec, ...] = (
    ...
    LegacyRouteSpec("POST", "/api/shared-sync/user-shares/links", "shared_sync_user_shares_link_create"),
    LegacyRouteSpec("POST", "/api/admin/shared-sync/migrate-v2", "admin_shared_sync_migrate_v2"),
    ...
    LegacyRouteSpec("POST", "/api/shared-sync/user-shares/links/{link_id}/preview", "shared_sync_user_shares_link_preview"),
    ...
    LegacyRouteSpec("POST", "/api/shared-sync/machine-sync/preview", "shared_sync_machine_preview"),
