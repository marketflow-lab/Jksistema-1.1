...
def create_cadastro_router() -> APIRouter:
    ...
    router.add_api_route("/lojas/{store_id}/importador-loja", cadastro.obter_importador_loja, methods=["GET"], name="obter_importador_loja")
    router.add_api_route("/lojas/{store_id}/importador-loja", cadastro.salvar_importador_loja, methods=["PUT"], name="salvar_importador_loja")
