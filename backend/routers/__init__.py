...
def create_shared_sync_router():
    """Importa Shared Sync somente quando o runtime ja possui get_tenant_path."""
    from .shared_sync import create_shared_sync_router as factory
    return factory()
