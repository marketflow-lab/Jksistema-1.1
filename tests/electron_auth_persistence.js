...
assert.match(favoritosLoginFlow, /getAvantProStorageStatus[\s\S]*storageUsable[\s\S]*validarLoginAvantProAntesDeContinuarFavoritos[\s\S]*liveAuthConfirmed:\s*true/, 'continuacao deve aceitar sessao AvantPro persistida e salvar confirmacao DOM quando disponivel');
