...
CONTRACT_HASHES = {
    ...
    "policy": "571f6b7133350540afedd6f6112f5eb67bd5727389ccb59b4a3c387d7aadc25d",
    "prompts": "1a283297358424f27d31eb853d309b6b98c53610137ffdcc70ac212c5c68aced",
...
LAYERS = {
    ...
    "deep_research_passages": 2, "deep_research_target": 2,
...
def _contract_snapshot() -> dict[str, object]:
    ...
    prompt_targets = {
        ...
        "client_compatibility_workflow.py": ["compatibility_prompt"],
        "client_general_workflow.py": [
            "initial_general_response", "context_hub_response",
            "_prepare_general_research", "_general_gap_callback",
            "_evaluate_general_research", "_synthesize_general_answer", "web_fallback",
        ],
        "general_commercial.py": [
            "_general_fit_evaluation_prompt", "_general_research_final_prompt",
        ],
        "technical_planning.py": ["technical_evidence_graph_prompt"],
        "technical_resolution.py": [
