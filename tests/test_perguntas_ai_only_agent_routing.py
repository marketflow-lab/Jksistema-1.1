...
def test_response_policy_v13_applies_rvc_only_when_commercial_state_allows_it() -> None:
    ...
    assert "Somente com equivalencia comprovada de codigo, funcao e variacao, atribua ao produto a caracteristica" in policy
...
def test_codex_prompt_v23_hash_includes_vehicle_and_evidence_policies() -> None:
    from backend.services import perguntas_pos_venda_codex as codex

    assert codex.PROMPT_VERSION == "jk_ml_customer_reply_codex_v23"
