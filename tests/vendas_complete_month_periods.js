...
assert.match(htmlStatic, /periodos-completos\.js\?v=20260819-vendas-meses-completos-v1/);
...
assert.match(htmlStatic, /grafico\.js\?v=20260819-vendas-meses-completos-v1/);
...
assert.match(skuHtmlStatic, /periodos-completos\.js\?v=20260819-vendas-meses-completos-v1/);
...
async function testarCliqueConcorrenteAposMax() {
    ...
    assert.deepStrictEqual(atalho.periodosAplicados, [{ inicio: '2026-02-01', fim: '2026-07-31' }]);
...
async function testarRestauracaoPreferenciaLegada() {
    ...
    assert.deepStrictEqual(legado.obterDatas(), { inicio: '2026-02-01', fim: '2026-07-31' });
    ...
    assert.deepStrictEqual(maxPendenteSobre6m.obterDatas(), { inicio: '2026-02-01', fim: '2026-07-31' });
    ...
    assert.deepStrictEqual(interacaoAntesDaNormalizacao.obterDatas(), { inicio: '2026-05-01', fim: '2026-07-31' });
...
async function testarAplicacaoPeriodoSku() {
    ...
    assert.deepStrictEqual(fixo.periodosAplicados, [{ inicio: '2026-02-01', fim: '2026-07-31' }]);
