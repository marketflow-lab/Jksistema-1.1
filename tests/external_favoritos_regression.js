...
function validarFluxoFavoritosAvantProSemReload() {
  ...
  assert.match(promocoesEfetivacao, /preco_atual_ml:\s*precoAtualMl[\s\S]*precoConcluido\s*\?\s*precoAtualMl[\s\S]*Alteracao parcial/, 'historico deve preservar o estado atual e distinguir alteracao parcial');
