...
assert.match(loader, /black-jhon-single-conversation-v1/);
...
assert.match(backend, /def _codex_canonical_conversation_id/);
assert.match(backend, /def _codex_run_conversation_queue/);
assert.match(backend, /def codex_reset_current_conversation/);
