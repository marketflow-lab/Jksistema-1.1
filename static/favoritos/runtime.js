const userData = JSON.parse(localStorage.getItem('user_data') || 'null');
        ...
        let mlFavoritosExecucaoIniciadaEmMs = 0;
        ...
        let mlHistoricoFavoritosPersistenciaFila = Promise.resolve({ success: true, historico: [] });
        let mlHistoricoFavoritosUltimaPersistenciaPromise = mlHistoricoFavoritosPersistenciaFila;
        ...
        let skuDescricaoAutoAbortController = null;
        const skuDescricaoMemCache = new Map();
        const SKU_DESCRICAO_CACHE_TTL_OK_MS = 30 * 60 * 1000;
        const SKU_DESCRICAO_CACHE_TTL_EMPTY_MS = 5 * 60 * 1000;
