(function (global) {
    ...
    const elements = {
        ...
        importadorLojaStatus: byId('importadorLojaStatus'),
        importadorLojaForm: byId('importadorLojaForm'),
        importadorNomeEmpresa: byId('importadorNomeEmpresa'),
        importadorTaxId: byId('importadorTaxId'),
        importadorTelefone: byId('importadorTelefone'),
        importadorEmail: byId('importadorEmail'),
        importadorContato: byId('importadorContato'),
        importadorLogradouro: byId('importadorLogradouro'),
        importadorBairro: byId('importadorBairro'),
        importadorCidade: byId('importadorCidade'),
        importadorCep: byId('importadorCep'),
        importadorEstado: byId('importadorEstado'),
        importadorPais: byId('importadorPais'),
        btnSalvarImportadorLoja: byId('btnSalvarImportadorLoja'),
