(function publicarPeriodosCompletos(global) {
    ...
    function calcularPeriodoComMesAtual(periodo, hoje = new Date()) {
        const mesesCompletos = calcularPeriodoMesesCompletos(periodo, hoje);
        if (!mesesCompletos) return null;

        return {
            inicio: mesesCompletos.inicio,
